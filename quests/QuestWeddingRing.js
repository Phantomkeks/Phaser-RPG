...
class QuestWeddingRing extends BaseScene {
  ...
  warmthFor(dist) {
    ...
    if (ratio < 0.3) return { label: "Hot!", color: "#ff6ec7", tintInt: 0xff6ec7 };
    if (ratio < 0.5) return { label: "Warm.", color: "#ffd166", tintInt: 0xffd166 };
