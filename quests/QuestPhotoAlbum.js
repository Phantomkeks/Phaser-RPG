...
class QuestPhotoAlbum extends BaseScene {
  constructor() { super('QuestPhotoAlbum'); }
  ...
  create() {
    ...
    const deck = Phaser.Utils.Array.Shuffle(
      this.memories.flatMap(m => [m.key, m.key])
    );
    ...
    this.captionText = this.add.text(width / 2, height - 75, '', {
      ...THEME.text.small, color: THEME.colors.white,
  ...
  evaluate() {
    ...
    if (a.memoryKey === b.memoryKey) {
      ...
      this.time.delayedCall(900, () => {
        a.setTexture('card_back'); a.faceUp = false;
        b.setTexture('card_back'); b.faceUp = false;
        this.flipped = [];
        this.locked = false;
      });
    }
  ...
  makeTextures() {
    ...
    make('card_back', g => {
      g.fillStyle(0x6b4f8a, 1); g.fillRect(0, 0, 16, 16);
      g.lineStyle(1, 0xffd166, 1);
      g.strokeRect(1, 1, 14, 14);
      g.fillStyle(0xffd166, 1); g.fillRect(7, 7, 2, 2);
    });

    make('mem_beach', g => {
      g.fillStyle(0x7ec8ff, 1); g.fillRect(0, 0, 16, 9);
      g.fillStyle(0xfff3b0, 1); g.fillRect(0, 9, 16, 7);
      g.fillStyle(0xffd700, 1); g.fillRect(11, 1, 3, 3);
    });
    make('mem_pizza', g => {
      g.fillStyle(0xf6c177, 1); g.fillRect(2, 2, 12, 12);
      g.fillStyle(0xef476f, 1); g.fillRect(5, 5, 2, 2); g.fillRect(9, 9, 2, 2);
      g.fillStyle(0x52b788, 1); g.fillRect(8, 4, 1, 1); g.fillRect(4, 10, 1, 1);
    });
    make('mem_concert', g => {
      g.fillStyle(0x1a0a2e, 1); g.fillRect(0, 0, 16, 16);
      g.fillStyle(0xff6ec7, 1); g.fillRect(7, 4, 2, 7);
      g.fillStyle(0xffd166, 1); g.fillRect(6, 11, 4, 1);
      g.fillStyle(0xffffff, 1); g.fillRect(2, 2, 1, 1); g.fillRect(13, 3, 1, 1); g.fillRect(11, 12, 1, 1);
    });
    make('mem_dog', g => {
      g.fillStyle(0x9c6644, 1); g.fillRect(4, 5, 8, 7);
      g.fillStyle(0x9c6644, 1); g.fillRect(3, 4, 2, 3); g.fillRect(11, 4, 2, 3);
      g.fillStyle(0x000000, 1); g.fillRect(6, 7, 1, 1); g.fillRect(9, 7, 1, 1);
      g.fillStyle(0x000000, 1); g.fillRect(7, 9, 2, 1);
    });
    make('mem_camp', g => {
      g.fillStyle(0x2d6a4f, 1); g.fillRect(0, 12, 16, 4);
      g.fillStyle(0xef476f, 1);
      for (let r = 0; r < 8; r++) {
        const w = 8 - r;
        g.fillRect(8 - Math.floor(w / 2), 4 + r, w, 1);
      }
      g.fillStyle(0xffd166, 1); g.fillRect(13, 1, 1, 1); g.fillRect(2, 2, 1, 1);
    });
    make('mem_coffee', g => {
      ...
      g.fillStyle(0xef476f, 1); g.fillRect(6, 6, 1, 1); g.fillRect(8, 6, 1, 1);
    });
  }
}
